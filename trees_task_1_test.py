...
class MyTests(unittest.TestCase):
    ...
    def test393(self): # список всех узлов дерева
        ...
        n12 = SimpleTreeNode(4, None)
        n13 = SimpleTreeNode(5, None)
        n21 = SimpleTreeNode(6, None)
        T = SimpleTree(n0)
        T.AddChild(n0, n1)
        T.AddChild(n0, n2)
        T.AddChild(n0, n3)
        ...
        self.assertEqual(all_Nodes[3].NodeValue, 3)
        self.assertEqual(all_Nodes[4].NodeValue, 4)
        self.assertEqual(all_Nodes[5].NodeValue, 5)
        self.assertEqual(all_Nodes[6].NodeValue, 6)
