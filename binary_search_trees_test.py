...
class MyTests(unittest.TestCase):
    ...
    def test60(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
        tree.AddKeyValue(1, 11)
        tree.AddKeyValue(3, 31)
        tree.AddKeyValue(6, 61)
        tree.AddKeyValue(5, 51)
        tree.AddKeyValue(7, 71)
        tree.AddKeyValue(12, 121)
        tree.AddKeyValue(10, 101)
        tree.AddKeyValue(9, 91)
        tree.AddKeyValue(11, 111)
        tree.AddKeyValue(14, 141)
        tree.AddKeyValue(13, 131)
        tree.AddKeyValue(15, 151)
        ...
        self.assertEqual(tree.FindNodeByKey(8).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(4).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(2).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(3).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(6).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(5).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(7).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(10).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(9).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(11).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(14).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(15).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(13).NodeHasKey, True)

        self.assertEqual(tree.FindNodeByKey(1).NodeHasKey, False)
        self.assertEqual(tree.FindNodeByKey(12).NodeHasKey, False)

    def test61(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
        ...
        self.assertEqual(tree.FindNodeByKey(8).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(2).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(1).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(3).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(6).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(5).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(7).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(12).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(10).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(9).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(11).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(14).NodeHasKey, True)
        ...
        self.assertEqual(tree.FindNodeByKey(13).NodeHasKey, False)
        self.assertEqual(tree.FindNodeByKey(4).NodeHasKey, False)

    def test62(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
    ...
    def test63(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
        ...
        self.assertEqual(tree.FindNodeByKey(6).NodeHasKey, False)
        self.assertEqual(tree.FindNodeByKey(10).NodeHasKey, False)

    def test64(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
        ...
        self.assertEqual(tree.FindNodeByKey(8).NodeHasKey, False)

    def test65(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
        ...
        self.assertEqual(tree.FindNodeByKey(11).NodeHasKey, False)
        self.assertEqual(tree.FindNodeByKey(8).NodeHasKey, False)

    def test66(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
        ...
        self.assertEqual(tree.FindNodeByKey(15).NodeHasKey, False)
        self.assertEqual(tree.FindNodeByKey(8).NodeHasKey, False)

    def test67(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
        ...
        self.assertEqual(tree.FindNodeByKey(14).NodeHasKey, False)
        self.assertEqual(tree.FindNodeByKey(15).NodeHasKey, False)

    def test68(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
    ...
    def test69(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
        ...
        self.assertEqual(tree.FindNodeByKey(9).NodeHasKey, False)
        self.assertEqual(tree.FindNodeByKey(11).NodeHasKey, False)

    def test70(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
    ...
    def test71(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
        ...
        self.assertEqual(tree.FindNodeByKey(15).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(13).NodeHasKey, True)
        self.assertEqual(tree.FindNodeByKey(7).NodeHasKey, False)
        self.assertEqual(tree.FindNodeByKey(9).NodeHasKey, False)

    def test72(self):  # количество узлов в дереве
        root = BSTNode(8, 81, None)
        tree = BST(root)
        tree.AddKeyValue(4, 41)
        tree.AddKeyValue(2, 21)
